...
public class EmployeeDepartment {
	...
	private Collection<EmployeeAccount> employee = new ArrayList<EmployeeAccount>();
	...
	public Collection<EmployeeAccount> getEmployee() {
		return employee;
	}

	public void setEmployee(Collection<EmployeeAccount> employees) {
